...
public class Player2 extends Character{
    ...
    public Player2(int x, int y, Image img) {
        super( x, y, img);
        this.isKilled = false;
                ...
                switch (direction) {
                    case UP:
                        if (checkCollisions(x, y - step)) {
                            this.y -= step;
                            this.img = Sprite.movingSprite(Sprite.player2_up, Sprite.player2_up_1, Sprite.player2_up_2, _animate, 60).getFxImage();
                    ...
                    case DOWN:
                        if (checkCollisions(x, y + step)) {
                            this.y += step;
                            this.img = Sprite.movingSprite(Sprite.player2_down, Sprite.player2_down_1, Sprite.player2_down_2, _animate, 60).getFxImage();
                    ...
                    case RIGHT:
                        if (checkCollisions(x + step, y)) {
                            this.x += step;
                            this.img = Sprite.movingSprite(Sprite.player2_right, Sprite.player2_right_1, Sprite.player2_right_2, _animate, 60).getFxImage();
                    ...
                    case LEFT:
                        if (checkCollisions(x - step, y)) {
                            this.x -= step;
                            this.img = Sprite.movingSprite(Sprite.player2_left, Sprite.player2_left_1, Sprite.player2_left_2, _animate, 60).getFxImage();
    ...
    public void dieImg() {
        if (deathCountDown == 0) {
            ...
            this.img = Sprite.movingSprite(Sprite.player2_dead1, Sprite.player2_dead2, Sprite.player2_dead3, _animate, 60).getFxImage();
            deathCountDown--;
        }
    }
...
//                this.boundary.setPosition(x, y, 0);
    ...
    public void addBomb() {
        bombCount++;
        System.out.println("Player2 return bomb " + bombCount);
    }
    ...
    public void dropBomb() {
        ...
        bombPlaced.setPlayerDrop("Player2");
