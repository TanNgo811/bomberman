...
//        img = ImageUtils.loadImage("Resources/img/sprites_without_border.png");
        img = ImageUtils.loadImage("res/sprites_without_border.png");
    }
    ...
    public static void playAnimation(SpriteAnimation sprite) {
        double time = GameLoop.getCurrentGameTime();
        GraphicsContext gc = Sandbox.getGraphicContext();
